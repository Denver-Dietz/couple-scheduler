    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        <div className="flex items-center justify-between" style={{ marginBottom: '0.75rem' }}>
          ...
          {isDashboardOwner && (
            <button aria-label={showCommitForm ? "Close appointment form" : "Open appointment form"} className="btn btn-outline" onClick={() => setShowCommitForm(!showCommitForm)}
      ...
      <div>
        <div className="flex items-center justify-between" style={{ marginBottom: '0.75rem' }}>
          ...
          {isDashboardOwner && (
            <button aria-label={showGoalForm ? "Close goal form" : "Open goal form"} className="btn btn-outline" onClick={() => setShowGoalForm(!showGoalForm)}
              style={{ padding: '0.3rem 0.6rem', fontSize: '0.8rem' }}>
      ...
      <div>
        <div className="flex items-center justify-between" style={{ marginBottom: '0.75rem' }}>
          ...
          {isDashboardOwner && (
            <button aria-label={showProjectForm ? "Close project form" : "Open project form"} className="btn btn-outline" onClick={() => setShowProjectForm(!showProjectForm)}
              style={{ padding: '0.3rem 0.6rem', fontSize: '0.8rem' }}>
